...
- **Open:** `1 task not done` — T12 `doing`: NFR-1's absolute bound (p95 ≤ 100 ms) is not met on the dev machine by any hook, old or new (evidence §8); waiting for the user's call. T1 findings changed D2 by user ruling — see Deviations D-T1-1…5.
