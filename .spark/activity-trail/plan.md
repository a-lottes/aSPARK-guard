...
- **Open:** `5 tasks not done` — T13–T17, see §3. Carried to `/peer-review`: `EXPECTED_EVENTS` edit (ruling Q1). NFR-1 as amended (C15) is closed by T17, not by T12's deviation.
