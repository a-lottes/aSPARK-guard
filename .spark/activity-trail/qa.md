...
- **Open:** `none open` — B4 (Major), B1, B2 `fixed` by `/increment` fix-mode (plan T13–T16, spec C14), awaiting re-test; B3 `accepted` by the user (2026-09-23).
